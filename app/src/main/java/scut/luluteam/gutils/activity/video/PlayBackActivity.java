...
import scut.luluteam.gutils.activity.video.other.WindowSizeChangeNotifier;
import scut.luluteam.gutils.view.timeshaftbar.TimerShaftBar;
import scut.luluteam.gutils.view.timeshaftbar.TimerShaftRegionItem;

import static scut.luluteam.gutils.activity.video.PlayActivity.APPKEY;
import static scut.luluteam.gutils.activity.video.PlayActivity.AccessToekn;
import static scut.luluteam.gutils.activity.video.PlayActivity.Global_AreanDomain;
import static scut.luluteam.gutils.activity.video.PlayActivity.PLAY_URL;
