...
public class SocketService extends Service {
    ...
    public static class SocketManager {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        if (!isConnected) {
                            ...
                            ShowUtil.Toast(App.getAppContext(), "connected");
                            isConnected = true;
                        }
                    }
                });
        ...
        private Emitter.Listener onDisconnect = new Emitter.Listener() {
            ...
            public void call(Object... args) {
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        ShowUtil.Toast(App.getAppContext(), "diconnected");
                        isConnected = false;
                    }
                });
            }
            ...
            public void call(Object... args) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ShowUtil.Toast(App.getAppContext(), "Error connecting");
                        isConnected = false;
                    }
                });
            }
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            ShowUtil.Toast("receive new message:" + data.toString());
        ...
        private void start() {
            ...
            if (isConnected) {
                ShowUtil.Toast("Socket is connected");
                return;
            }
